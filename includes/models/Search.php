 ...
 * @package Model
 */
class Model_Shop_Search extends Model_Shop_Base
{
	public $states = array(
		'alabama'		 =>'AL',
		'alaska'		 =>'AK',
	...
	{		
		$phtml[0] = PROSPERSHOP_VIEW . '/prospersearch/product.php';
		$phtml[1] = PROSPERSHOP_VIEW . '/prospersearch/productPage.php';
	...
	public function searchShortcode($atts, $content = null)
	{
		...
		require_once(PROSPERSHOP_VIEW . '/prospersearch/searchShort.php');
	}
