 ...
 * @package Model
 */
class Model_Shop_Activate extends Model_Shop_Base
{
	protected $_options;
	...
	{
		add_option('prosperShopActivationRedirect', true);
	}

	public function prosperActivateRedirect() 
	{
		if (get_option('prosperShopActivationRedirect', false)) 
		{
			delete_option('prosperShopActivationRedirect');
			if(!isset($_GET['activate-multi']))
			{
				wp_redirect( admin_url( 'admin.php?page=prospershop_general' ) );
			}
		}
	}
