...
echo '<p class="prosper_settingDesc">' . __( 'Go to <a href="http://wordpress.prosperentdemo.com/prodstore/">WordPress Prosperent Demo: ProsperShop</a> for more information and tutorials.', 'prosperent-suite' ) . '</p>';
...
if ($options['Enable_Caching'] &&  (file_exists(PROSPERSHOP_CACHE) || substr(decoct( fileperms(PROSPERSHOP_CACHE) ), 1) == '0777'))
{
