 ...
 * @subpackage 
 */
class ProsperShopIndexController
{	
    public function __construct()
    {		
		require_once(PROSPERSHOP_MODEL . '/Activate.php');
		$prosperActivate = new Model_Shop_Activate();
		
		add_action('widgets_init', array($prosperActivate, 'createWidget'), 4);	
		
		register_activation_hook(PROSPERSHOP_PATH . PROSPERSHOP_FILE, array($prosperActivate, 'prosperActivate'));
		register_deactivation_hook(PROSPERSHOP_PATH . PROSPERSHOP_FILE, array($prosperActivate, 'prosperDeactivate'));
...
$prosperShopIndex = new ProsperShopIndexController;