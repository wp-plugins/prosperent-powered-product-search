...
Add Prosperent's ProsperShop to your blog and have access to over 4500 merchants and millions of products.

== Description ==

This plugin will add a fully functional shop to your WordPress blog with a few clicks. 

To view a tutorials and a demo of the ProsperShop, visit [ProsperShop Demo](http://wordpress.prosperentdemo.com/prodstore/)
...
2.	Upload the **prosperent-powered-product-search** folder to the **/wp-content/plugins/** directory.
3.	Activate the plugin through the *Plugins* menu in WordPress.
4.	Go to the **ProsperShop** under Settings and edit those that you'd like. 
5.  Go to General Settings to input your API Key.
6.  Go to Shop Settings to fine tune your shop.
6.  Go to *Appearance* and then *Widgets* in your admin menu.
    * There are widgets available for the Search Bar for the Product Search and a Top Product widget.
...
8.	Congratulations, you now have the ProsperShop on your WordPress site.
...
= 3.4 =
* Updated Prosperent Product Search to ProsperShop
* Optimized code
* Updated options
* Updated look of store, grabs more CSS from active theme
